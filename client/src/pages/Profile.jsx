  ...
  return (
    <div className="h-fit pt-20">
      <div className="max-w-2xl mx-auto p-4 py-8">
        <div className="rounded-xl p-6 space-y-8 text-secondary bg-accent shadow-lg">
          <div className="text-center  border-b-2 border-slate-400 py-1">
              ...
              {isEditingName ? (
                <div className="flex gap-2">
                  <input
                    ...
                    className="px-4 py-2.5 bg-base-200 rounded-lg border flex-1 text-black"
                    disabled={isUpdatingProfile}
                    autoFocus
                  />
                  <button
          ...
          <div className="mt-6 bg-primary rounded-xl p-6">
